...
[`_core/_schema/_code.md`](../_core/_schema/_code.md)) once the plugin has real types.
...
- Decide the first widgets/systems it owns (candidates: HUD base, menu framework,
  ...
  [UnrealGameMechanics](../UnrealGameMechanics/CLAUDE.md)'s `UDWidgetBase` and the per-plugin
