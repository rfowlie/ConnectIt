...
| `knowledge/raw/<slug>/` | Advisor source material, verbatim. Local rules: [`knowledge/raw/__README.md`](knowledge/raw/__README.md). |
| `knowledge/wiki/<slug>.md` | One synthesis (voice profile) per advisor — what `/ask-the-board` reads. Local rules: [`knowledge/wiki/__README.md`](knowledge/wiki/__README.md). |
...
| [`questions/`](questions/) | One file per board consultation. Local rules: [`questions/__README.md`](questions/__README.md). |
