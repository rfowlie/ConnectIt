...
Not a `_decisions/` folder: a consultation is an *input* to a decision, not the decision
itself. If the consultation settles a call, that call also gets a note in
`../_knowledge/me/_decisions/` (see [`../../_schema/decisions.md`](../../_schema/decisions.md)).
