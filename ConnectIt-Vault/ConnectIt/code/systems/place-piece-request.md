...
2. **Freeze** — `UTurnBasedActionsComponent::HandleBoardChangeRequested` pushes the
   ...
   ([[UnrealTurnBasedMechanics/code/systems/action-stack-lifecycle|action-stack-lifecycle]] §4).
...
step is [[UnrealGameMechanics/code/systems/gated-event-tag-queue|gated-event-tag-queue]].
