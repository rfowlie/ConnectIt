...
- [[2026-09-04]] — session — UI-value catalogue (`UIValueCatalogue.md`, now folded into the vault) + 7 accessor gaps closed + 2 correctness bugs fixed across `AConnectIt_GameState`/`UnrealTurnBasedMechanics`; faction-visuals subsystem (Gap 1) built then removed same session, see [[ConnectIt/decisions/2026-09-09-faction-visuals-subsystem-built-then-removed|decision note]]. Predates the 2026-09-08 board-architecture overhaul — see log for what has since moved/retired.
