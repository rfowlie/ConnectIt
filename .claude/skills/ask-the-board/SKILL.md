...
description: >-
  ...
  board-of-advisors/board-of-advisors.md (and any board-of-advisors/knowledge/wiki/*.md
  ...
  board-of-advisors/knowledge/me/career-coach.md, and logs the consultation to
  board-of-advisors/questions/. Use when the user asks to "ask the board", wants advisor
...
2. **`board-of-advisors/knowledge/me/career-coach.md`** — the user's situation, goals,
   ...
   Also check `board-of-advisors/knowledge/me/decisions/` for calls already made — don't
   reopen them, and skim `board-of-advisors/questions/` for prior consultations on the same topic.
3. **`board-of-advisors/knowledge/wiki/<slug>.md`** for each advisor, if it exists — the
...
4. **`board-of-advisors/knowledge/raw/<slug>/`** — only dip into these if the wiki is thin
...
- Ground every step in `board-of-advisors/knowledge/me/career-coach.md`: name the
